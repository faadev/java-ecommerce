...
<html lang="pt-br">
    ...
    <body id="page-top">
        ...
        <header class="masthead" id="login">
            <div class="container">
                <div class="masthead-subheading">Bem Vindo � KubanzaCommerce!</div>
        ...
        <section class="page-section" id="beneficios">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Beneficiarios</h2>
                    <h3 class="section-subheading text-muted">Aqui na KubanzaCommerce voc� encontra os melhores pre�os!</h3>
                </div>
